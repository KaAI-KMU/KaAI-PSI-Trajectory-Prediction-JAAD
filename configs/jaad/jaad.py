...
def parse_sgnet_args():
    ...
    parser.add_argument('--bbox_output_dim', default=256, type=int)
    parser.add_argument('--flow_output_dim', default=320, type=int)
    parser.add_argument('--observe_length', default=15, type=int)
